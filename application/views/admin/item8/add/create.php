...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header">Certificate Create
            ...
            <div class="p20">
                ...
                <form action="<?php echo base_url('admin_create_item_ce_act'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                            ...
                            <select id="cate" class="form-control" name="category">
                                ...
                                <?php foreach ($get_all_item_category as $item){ ?>
                                    <option value="<?php echo $item->i_c8_id; ?>"><?php echo $item->i_c8_name; ?></option>
                                <?php } ?>
